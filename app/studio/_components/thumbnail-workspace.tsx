      ...
      <section className="module-main">
        ...
        <div className="module-content thumbnail-content">
          ...
          <section className="thumbnail-handoff">
            ...
            <div className="thumbnail-handoff-actions"><button type="button" disabled={!selectedIdea || !scriptRecord} onClick={() => setSourceOpen(true)}>View story source</button><Link href="/studio/audio" onClick={(e) => studioNavigate('/studio/audio', e)}>← Back to Audio</Link></div>
          </section>
          ...
          <section className="thumbnail-builder">
            ...
            <div className="thumbnail-model-bar">
              ...
              </> : <div className="thumbnail-no-model"><span>◇</span><div><strong>No AI model connected</strong><small>Add one provider and choose a capable model. Your key remains in this browser.</small></div><Link href="/studio/settings" onClick={(e) => studioNavigate('/studio/settings', e)}>Open Settings →</Link></div>}
            </div>
            ...
            {!handoffReady ? <div className="thumbnail-prerequisite"><span>!</span><div><strong>The production handoff is incomplete</strong><p>Finish Research, Final Script and one current Audio Plan first.</p></div><Link href="/studio/audio" onClick={(e) => studioNavigate('/studio/audio', e)}>Open Audio</Link></div> : null}
