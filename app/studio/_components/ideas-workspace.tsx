        ...
        <div className="module-content idea-pro-content">
          ...
          <section className="idea-pro-panel" id="idea-controls">
            ...
            {connections.length ? (
              ...
              <div className="idea-pro-no-model"><span>◇</span><div><strong>No AI model connected</strong><small>Connect a provider and select a model before generating ideas.</small></div><Link href="/studio/settings" onClick={(e) => studioNavigate('/studio/settings', e)}>Open Settings →</Link></div>
            )}
