  ...
  return <main className="module-shell module-lime shorts-shell">
    ...
    <section className="module-main">
      ...
      <div className="module-content shorts-content">
        ...
        <footer className="shorts-footer"><a href="/studio/description" onClick={(e) => studioNavigate('/studio/description', e)}><span>Previous section</span><strong>← Description</strong></a><div><span>Saved optional Shorts</span><strong>{shorts.slots.filter(Boolean).length} · up to 3</strong></div><p>This is the final Studio section. Publish only the Shorts you genuinely want to use.</p></footer>
      </div>
    </section>
  </main>;
}